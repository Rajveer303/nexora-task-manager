    ...
    <div style={{
      ...
      <div className="card fade-in" style={{ width: "100%", maxWidth: 440 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
          <h2 style={{ fontFamily: "var(--font-family)", fontWeight: 700, fontSize: 20 }}>
        ...
        {error && <div style={{ background: "rgba(255,59,59,.1)", border: "1px solid rgba(255,59,59,.2)", borderRadius: "var(--radius)", padding: "10px 14px", marginBottom: 16, fontSize: 14, color: "var(--accent)" }}>{error}</div>}
  ...
  return (
    <div style={{ padding: "28px 32px" }} className="fade-in">
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
        <div>
          <h1 style={{ fontFamily: "var(--font-family)", fontWeight: 800, fontSize: 26, letterSpacing: "-.02em" }}>Projects</h1>
            ...
            return (
              ...
              >
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 10 }}>
                  <div>
                    <h3 style={{ fontFamily: "var(--font-family)", fontWeight: 700, fontSize: 17 }}>{p.name}</h3>
                  ...
                  <div style={{ display: "flex", gap: 4 }} onClick={e => e.stopPropagation()}>
                    ...
                    <button className="btn-icon" style={{ width: 28, height: 28, color: "var(--accent)", borderColor: "rgba(255,59,59,.2)" }}
                ...
                <div style={{ marginBottom: 12 }}>
                  ...
                  <div style={{ height: 4, background: "var(--border)", borderRadius: 99, overflow: "hidden" }}>
                    <div style={{
                      ...
                      width: `${pct}%`, background: pct === 100 ? "var(--text)" : p.color,
