...
function StatCard({ label, value, color, icon }) {
  return (
    <div className="card" style={{ display: "flex", alignItems: "center", gap: 16 }}>
      ...
      <div>
        <div style={{ fontSize: 26, fontFamily: "var(--font-family)", fontWeight: 800, lineHeight: 1 }}>{value ?? "—"}</div>
  ...
  return (
    <div style={{ padding: "28px 32px", maxWidth: 1100 }} className="fade-in">
      ...
      <div style={{ marginBottom: 28 }}>
        <h1 style={{ fontFamily: "var(--font-family)", fontWeight: 800, fontSize: 28, letterSpacing: "-.02em" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 14, marginBottom: 28 }}>
        <StatCard label="Total Tasks" value={s?.total} color="var(--accent)" icon={
          <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><line x1="9" y1="3" x2="9" y2="21"/></svg>
        } />
        <StatCard label="In Progress" value={s?.in_progress} color="var(--text2)" icon={
          <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
        } />
        <StatCard label="Completed" value={s?.done} color="var(--text)" icon={
          <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
        } />
        <StatCard label="Overdue" value={s?.overdue} color="var(--accent)" icon={
        ...
        <StatCard label="Assigned to Me" value={s?.assigned_to_me} color="var(--text2)" icon={
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 300px", gap: 20 }}>
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
            <h2 style={{ fontFamily: "var(--font-family)", fontWeight: 700, fontSize: 18 }}>Recent Activity</h2>
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
            <h2 style={{ fontFamily: "var(--font-family)", fontWeight: 700, fontSize: 18 }}>Projects</h2>
                ...
                >
                  ...
                  <div style={{ height: 4, background: "var(--border)", borderRadius: 99, overflow: "hidden" }}>
                    <div style={{
                      ...
                      width: `${pct}%`,
                      background: pct === 100 ? "var(--text)" : p.color,
