      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <h1 style={{ fontFamily: "var(--font-family)", fontWeight: 800, fontSize: 24, letterSpacing: "-.02em" }}>
              {project?.name}
            </h1>
          </div>
          {isAdmin && (
        ...
        <div style={{ maxWidth: 600 }}>
          {isAdmin && (
            <div className="card" style={{ marginBottom: 16 }}>
              ...
              {memberError && (
                <div style={{ color: "var(--accent)", fontSize: 13, marginBottom: 10, padding: "8px 12px", background: "rgba(255,59,59,.08)", borderRadius: "var(--radius)" }}>{memberError}</div>
              )}
            ...
            {members.map(m => (
              <div key={m.id} className="card" style={{ padding: "12px 16px", display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{
                  ...
                  fontWeight: 700, fontSize: 15, fontFamily: "var(--font-family)", flexShrink: 0,
                }}>{m.name[0]}</div>
                <div style={{ flex: 1 }}>
